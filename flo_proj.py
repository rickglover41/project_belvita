...
d_slr= None # standard labor hourly rate (dollars)
...
def main():
    ...
    estimator_type = st.radio("Select estimator:", ["General Estimator", "Specific Hospital/System"])
    
    if estimator_type == "General Estimator":
        ...
        estimator_labor_rate = st.number_input(label="Contracted Labor Hourly Rate", min_value=0.00, max_value=1000.00, step=1.00, value=120.00)
        estimator_labor_fte = st.number_input(label="Contracted Labor FTEs", min_value=0.0, max_value=20000.0, step=1.0, value=50.0)
        estimator_current_rn_rate = st.number_input(label="Average Facility RN Labor Hourly Rate", min_value=0.00, max_value=1000.00, value=70.00)
        ...
        intermediate_labor_hours_needed = (estimator_labor_fte * 2080) * estimator_share_rn
        ...
        estimator_total_savings = estimator_agency_cost_3_yr - estimator_florence_placement_costs
    ...
    elif estimator_type == "Specific Hospital/System":
